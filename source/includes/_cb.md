...
var parameters = new api.Parameters();
        parameters.Add("campaign-id", "123");

var results = request.Get("/v2/cb/citations", parameters);
```
...
var results = request.Get("/v2/cb/get-all", parameters);
```
...
var parameters = new api.Parameters();
        parameters.Add("campaign-id", "5");

var results = request.Get("/v2/cb/get", parameters);
```
